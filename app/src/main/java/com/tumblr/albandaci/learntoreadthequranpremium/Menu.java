package com.tumblr.albandaci.learntoreadthequranpremium;
    ...
    public void OnClickButtonListenerRate() {
        ...
        Rate_button.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.tumblr.albandaci.learntoreadthequranpremium")));
                    }
                }
        );
    }
